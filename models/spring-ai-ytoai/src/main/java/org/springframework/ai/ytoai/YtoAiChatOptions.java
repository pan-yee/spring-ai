...
public class YtoAiChatOptions implements FunctionCallingOptions {
	 ...
	 */
	private @JsonProperty("tools") List<YtoAiApi.FunctionTool> tools;

	private @JsonProperty("tools1")  List<YtoAiApi.Foo> foos;
	 ...
	 * functions are present. Use the {@link YtoAiApi.ChatCompletionRequest.ToolChoiceBuilder} to create a tool choice object.
	 */
	...
	public List<YtoAiApi.FunctionTool> getTools() {
		return this.tools;
	}

	public void setTools(List<YtoAiApi.FunctionTool> tools) {
		this.tools = tools;
	}
	...
	public boolean equals(Object obj) {
		...
		YtoAiChatOptions other = (YtoAiChatOptions) obj;
		if (this.model == null) {
			if (other.model != null) {
				return false;
			}
	...
	@Override
	public YtoAiChatOptions copy() {
		return fromOptions(this);
	}

	public static class Builder {

		protected YtoAiChatOptions options;

		public Builder() {
			this.options = new YtoAiChatOptions();
		}

		public Builder(YtoAiChatOptions options) {
		...
		public Builder withTools(List<YtoAiApi.FunctionTool> tools) {

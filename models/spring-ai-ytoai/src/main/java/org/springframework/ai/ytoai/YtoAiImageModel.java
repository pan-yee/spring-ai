...
public class YtoAiImageModel implements ImageModel {
	...
	public YtoAiImageModel(YtoAiImageApi ytoAiImageApi) {
		this(ytoAiImageApi, org.springframework.ai.ytoai.YtoAiImageOptions.builder().build(),
	...
	private org.springframework.ai.ytoai.YtoAiImageOptions toYtoAiImageOptions(ImageOptions runtimeImageOptions) {
		org.springframework.ai.ytoai.YtoAiImageOptions.Builder ytoAiImageOptionsBuilder = org.springframework.ai.ytoai.YtoAiImageOptions
			.builder();

...
public class YtoAiApi {
	...
	private final YtoAiStreamFunctionCallingHelper chunkMerger = new YtoAiStreamFunctionCallingHelper();
	 ...
	 */
	public YtoAiApi(String zhiPuAiToken) {
		this(YtoApiConstants.DEFAULT_BASE_URL, zhiPuAiToken);
	}
	 ...
	 * @param zhiPuAiToken ZhiPuAI apiKey.
	 */
	public YtoAiApi(String baseUrl, String zhiPuAiToken) {
	 ...
	 */
	public YtoAiApi(String baseUrl, String zhiPuAiToken, RestClient.Builder restClientBuilder) {
	 ...
	 */
	public YtoAiApi(String baseUrl, String zhiPuAiToken, RestClient.Builder restClientBuilder, ResponseErrorHandler responseErrorHandler) {
	...
	public record ChatCompletionRequest(
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature) {
			this(null,null,messages, model, null,  null, false, temperature, null,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model, Double temperature, boolean stream) {
			this(null,null,messages, model, null,  null,  stream, temperature, null,
					null, null, null, null, null);
		}
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model,
			...
			this(null,null,messages, model, null, null,  false, 0.8, null,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, Boolean stream) {
			this(null,null,messages, null, null,  null,  stream, null, null,
					null, null, null, null, null);
		}
	...
	public record ChatCompletion(
			@JsonProperty("msgId") String id,
			@JsonProperty("sessionId") String sessionId,
			@JsonProperty("requestId") String requestId,
			@JsonProperty("chatType") String chatType,
			@JsonProperty("rasaResult") String rasaResult,
			@JsonProperty("contents") List<ChatCompletion.Choice> choices) {
	...
	public record ChatCompletionChunk(
			...
			@JsonProperty("chatType") String chatType,
			@JsonProperty("rasaResult") String rasaResult,
			@JsonProperty("contents") List<ChunkChoice> choices){

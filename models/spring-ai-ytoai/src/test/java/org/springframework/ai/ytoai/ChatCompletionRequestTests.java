...
public class ChatCompletionRequestTests {
	...
	public void createRequestWithChatOptions() {
		...
		var client = new YtoAiChatModel(new YtoAiApi("TEST"),
				YtoAiChatOptions.builder().withModel("DEFAULT_MODEL").withTemperature(66.6).build());
		...
		request = client.createRequest(new Prompt("Test message content",
				YtoAiChatOptions.builder().withModel("PROMPT_MODEL").withTemperature(99.9).build()), true);
	...
	public void promptOptionsTools() {
		...
		var client = new YtoAiChatModel(new YtoAiApi("TEST"),
				YtoAiChatOptions.builder().withModel("DEFAULT_MODEL").build());

		var request = client.createRequest(new Prompt("Test message content",
				YtoAiChatOptions.builder()

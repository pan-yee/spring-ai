...
/**
 * Integration tests for observation instrumentation in {@link YtoAiChatModel}.
 *
 * @author Geng Rong
 */
...
public class YtoAiChatModelObservationIT {
	...
	void observationForChatOperation() {
		...
		var options = YtoAiChatOptions.builder()
			.withModel(YtoAiApi.ChatModel.GLM_4_Air.getValue())
			.withMaxTokens(2048)

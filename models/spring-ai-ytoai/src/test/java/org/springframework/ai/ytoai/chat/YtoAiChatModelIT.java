...
package org.springframework.ai.ytoai.chat;
...
import org.springframework.ai.ytoai.YtoAiTestConfiguration;
import org.springframework.ai.ytoai.api.MockWeatherService;
...
class YtoAiChatModelIT {
	...
	void functionCallTest() {
		...
		var promptOptions = YtoAiChatOptions.builder()
			.withModel(YtoAiApi.ChatModel.GLM_4.getValue())
	...
	void multiModalityEmbeddedImage(String modelName) throws IOException {
		...
		var response = this.chatModel
			.call(new Prompt(List.of(userMessage), YtoAiChatOptions.builder().withModel(modelName).build()));
	...
	void streamingMultiModalityImageUrl() throws IOException {
		...
		Flux<ChatResponse> response = this.streamingChatModel.stream(new Prompt(List.of(userMessage),
				YtoAiChatOptions.builder().withModel(YtoAiApi.ChatModel.GLM_4V.getValue()).build()));

...
public class YtoAiImageProperties extends YtoAiParentProperties {
	...
	/**
	 * Options for YtoAI Image API.
	 */
	@NestedConfigurationProperty
	private YtoAiImageOptions options = YtoAiImageOptions.builder().build();

	public YtoAiImageOptions getOptions() {
		return this.options;
	}

	public void setOptions(YtoAiImageOptions options) {
